...
def get_args() -> EasyDict:
    ...
    parser.add_argument("--iter", help="maximum iterations")
    parser.add_argument(
        "--n_flow", help="number of flows in each block"
    )
    parser.add_argument("--n_block", help="number of blocks")
    parser.add_argument(
        "--no_lu",
        action="store_true",
    ...
    parser.add_argument("--n_bits", help="number of bits")
    parser.add_argument("--lr", help="learning rate")
    parser.add_argument("--img_size", help="image size")
    parser.add_argument("--temp", help="temperature of sampling")
    parser.add_argument("--n_sample", help="number of samples")
    ...
    parser.add_argument('--eval', action='store_true', help='Use for evaluating '
                                                                           'a model')
    ...
    parser.add_argument('--num_workers', help='Number of worker threads for dataloader')
    parser.add_argument('--config', help='Name of json config file (optional) cmd will be overriden by file option')
    parser.add_argument('--devices', help='number of gpu devices to use')
